...
global $wpdb;
		...
		echo "<figure class='wp-block-table is-style-stripes'>
				<table class='tablepress' id='membrviwtbl'>
				<thead><tr>
				<th>Member Id</th>
				<th>Member Name</th>
				<th>Is Married</th>
	...
	$plcnm_val = $after_jsndecd['mem_plc_nm'];
	...
	*/ 
	...
	";
		...
		echo "</tbody>	
			...
			//$split_to_array = explode(',', $resval[0]);
			//$dblquots_rmvd_res=str_replace('"', '', $sep_res_vals);
		    //print_r($sep_res_vals);
										/*
								echo " <br/>";
								echo $spouse_val;
								echo " <br/>";
	...
	?>		
             ...
             <?php if ( !is_front_page()) {?>
               <?php  /* get_sidebar(); I removed sidebar for full viewing of table */ ?> 
            <?php }?>
        <div class="clear"></div>
    </div><!-- row -->
</div><!-- container -->
...
.site-main{
	width:100%;
		...
		#membrviwtbl td, #membrviwtbl th {
			  border: 1px solid #ddd;
			  padding: 8px;
			}
		#membrviwtbl tr:nth-child(even){background-color: #f2f2f2;}

		#membrviwtbl tr:hover {background-color: #ddd;}
		#membrviwtbl th {
					  padding-top: 12px;
					  padding-bottom: 12px;
					  text-align: left;
					  background-color: #1e0332de;
					  color: white;
					}
